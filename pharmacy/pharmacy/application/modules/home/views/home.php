                ...
                <div class="row state-overview">
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="custom-bar-chart">
                            <ul class="y-axis">
                                <li><span><?php echo $settings->currency; ?>10000</span></li>
                                <li><span><?php echo $settings->currency; ?>8000</span></li>
                                <li><span><?php echo $settings->currency; ?>6000</span></li>
                                <li><span><?php echo $settings->currency; ?>4000</span></li>
                                <li><span><?php echo $settings->currency; ?>2000</span></li>
                            ...
                            <div class="bar ">
                                ...
                                ?>" data-toggle="tooltip" data-placement="top" style="<?php
                                     if (!empty($feb)) {
                                         echo 'height:' . array_sum($feb) * 100 / 10000;
                                     }
                                     ?>%""></div>
                            </div>
                            <div class="bar ">
                                ...
                                ?>" data-toggle="tooltip" data-placement="top" style="<?php
                                     if (!empty($mar)) {
                                         echo 'height:' . array_sum($mar) * 100 / 10000;
                                     }
                                     ?>%"></div>
                            </div>
                            <div class="bar ">
                            ...
                            <div class="bar">
                                ...
                                ?>" data-toggle="tooltip" data-placement="top" style="<?php
                                     if (!empty($may)) {
                                         echo 'height:' . array_sum($may) * 100 / 10000;
                                     }
                                     ?>%""></div>
                            </div>
                            <div class="bar ">
                                ...
                                ?>" data-toggle="tooltip" data-placement="top" style="<?php
                                     if (!empty($jun)) {
                                         echo 'height:' . array_sum($jun) * 100 / 10000;
                                     }
                                     ?>%""></div>
                            </div>
                            <div class="bar">
                                ...
                                ?>" data-toggle="tooltip" data-placement="top" style="<?php
                                     if (!empty($jul)) {
                                         echo 'height:' . array_sum($jul) * 100 / 10000;
                                     }
                                     ?>%""></div>
                            </div>
                            <div class="bar ">
                                ...
                                ?>" data-toggle="tooltip" data-placement="top" style="<?php
                                     if (!empty($aug)) {
                                         echo 'height:' . array_sum($aug) * 100 / 10000;
                                     }
                                     ?>%""></div>
                            </div>
                            <div class="bar ">
                                ...
                                ?>" data-toggle="tooltip" data-placement="top" style="<?php
                                     if (!empty($sep)) {
                                         echo 'height:' . array_sum($sep) * 100 / 10000;
                                     }
                                     ?>%""></div>
                            </div>
                            <div class="bar ">
                                ...
                                ?>" data-toggle="tooltip" data-placement="top" style="<?php
                                     if (!empty($oct)) {
                                         echo 'height:' . array_sum($oct) * 100 / 10000;
                                     }
                                     ?>%""></div>
                            </div>
                            <div class="bar ">
                                ...
                                ?>" data-toggle="tooltip" data-placement="top" style="<?php
                                     if (!empty($nov)) {
                                         echo 'height:' . array_sum($nov) * 100 / 10000;
                                     }
                                     ?>%""></div>
                            </div>
                            <div class="bar ">
                                ...
                                ?>" data-toggle="tooltip" data-placement="top" style="<?php
                                     if (!empty($dec)) {
                                         echo 'height:' . array_sum($dec) * 100 / 10000;
                                     }
                                     ?>%""></div>
                            </div>
                        </div>
